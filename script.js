...
//this is where the fetch API happens
...
function displayCountries(countries) {
    ...
    //each country is rendered into a div
    ...
    countries.forEach(country => {
        ...
        const currency = country.currencies ? Object.values(country.currencies)[0].name : 'Unknown'; // Get the first currency's name
        const languages = country.languages ? Object.values(country.languages).join(', ') : 'Unknown'; // Join all languages with a comma
...
function searchCountry() {
    ...
    const filteredCountries = countriesData.filter(country => country.name.common.toLowerCase().includes(searchInput));
